...
namespace BagUnitTests
{
    ...
    public class Tests
    {
        ...
        public void Setup()
        {
            testBag = new Bag(new string[] { "testbag" }, "test bag", "A testing bag");
        ...
        {
            string expectedDescription = "In the test bag you can see:\n\ta gold pencil (pencil)\n\ta nvidia monitor (monitor)";
        ...
        public void Locate_ShouldFindNestedBagsAndItems()
        {
            ...
            GameObject itemInB1 = new Item(new string[] { "item1"}, "item in b1", "An item in bag 1");
            GameObject itemInB2 = new Item(new string[] {"item2" }, "item in b2", "An item in bag 2");
        ...
        public void Locate_ShouldNotFindPrivilegedItemInNestedBag()
        {
            ...
            GameObject priviledgedItem = new Item(new string[] { "priviledged"},"priviledged item", "A priviledge item");
